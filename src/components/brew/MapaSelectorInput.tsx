  ...
  return (
    <div className="space-y-3" ref={containerRef}>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        {matchedProduct ? (
          <div className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 dark:bg-emerald-500/10 dark:border-emerald-500/30 dark:text-emerald-400 text-[10px] font-bold shadow-2xs">
        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-mono font-bold text-amber-800 dark:text-amber-300 focus:outline-none focus:border-amber-500"
            />
            {loading && (
      ...
      {mapaRegistration.trim().length > 3 && !matchedProduct && (
        <div className="flex items-center justify-between p-2 rounded-xl bg-amber-50/70 dark:bg-slate-900/80 border border-amber-200/70 dark:border-slate-800 text-[11px]">
          ...
          <button
            ...
            className="text-amber-700 dark:text-amber-400 font-bold hover:underline flex items-center gap-1 disabled:opacity-50"
          >
            {savingQuick ? (
              <>
