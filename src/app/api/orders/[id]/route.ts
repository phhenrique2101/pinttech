  ...
  try {
    ...
    const updated = await prisma.order.update({
      ...
      data: {
        ...
        driverName: driverName !== undefined ? (driverName ? String(driverName).trim() : null) : existing.driverName,
        driverUserId: driverUserId !== undefined ? (driverUserId ? String(driverUserId).trim() : null) : existing.driverUserId,
