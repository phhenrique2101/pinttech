...
const ENTITY_CONFIGS: Record<EntityType, EntityDefinition> = {
  ...
  KEGS: {
    ...
    fields: [
      ...
      { key: 'currentVolumeLiters', label: 'Quantidade Real de Chopp Envasado (Litros)', synonyms: ['quantidade real', 'real envasado', 'volume real', 'litros envasados', 'volume envasado', 'quantidade envasada', 'envasado', 'volume', 'saldo litros', 'litros reais', 'qtd real', 'litros', 'l'], example: '0 para barril vazio / 50 para cheio' },
      { key: 'currentBeerName', label: 'Cerveja / Chopp Envasado (Se Cheio)', synonyms: ['cerveja', 'nome cerveja', 'nome do chopp', 'chopp', 'rotulo', 'rótulo', 'produto', 'conteudo'], example: 'German Pilsen' },
      ...
      },
      {
        ...
        example: '900.00 (para 50L)',
      },
      {
        key: 'costPerLiter',
        label: 'Custo de Fabricação / Litro (R$)',
        synonyms: [
          'custo por litro',
          'custo do litro',
          'custo/litro',
      ...
      { key: 'clientName', label: 'Cliente com Barril Emprestado / Comodato (Se no Cliente)', synonyms: ['cliente', 'cliente atual', 'ponto de venda', 'pdv', 'posse', 'em comodato com', 'com quem esta', 'com quem está', 'bar', 'restaurante', 'nome do cliente', 'emprestado', 'comodato', 'cliente em comodato'], example: 'Bar do Zé & Petiscos' },
      { key: 'kegType', label: 'Tipo de Barril', synonyms: ['tipo', 'modelo', 'engate', 'valvula'], example: 'INOX_EURO' },
      { key: 'status', label: 'Status Atual (DISPONIVEL, NO_CLIENTE, EM_ESTOQUE, VAZIO_SUJO)', synonyms: ['status', 'situacao', 'situação', 'estado', 'disponibilidade', 'status atual', 'status do barril', 'disponivel', 'disponível', 'posse'], example: 'DISPONIVEL (ou HIGIENIZADO)' },
      { key: 'notes', label: 'Observações Gerais', synonyms: ['observacoes', 'observações', 'obs', 'notas'], example: 'Válvula Tipo S revisada' },
    ],
    sampleData: [
      { 'Código / Patrimônio do Barril': 'BAR-50L-001', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 0, 'Cerveja / Chopp Envasado': '', 'Estilo da Cerveja': '', 'Preço por Litro (R$)': '', 'Custo por Litro (R$)': '', 'Lote de Produção': '', 'Cliente (Se Emprestado no Cliente)': '', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'DISPONIVEL', 'Observações Gerais': 'Vazio e higienizado na cervejaria (Pronto p/ Envase)' },
      { 'Código / Patrimônio do Barril': 'BAR-50L-002', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 50, 'Cerveja / Chopp Envasado': 'German Pilsen', 'Estilo da Cerveja': 'Pilsner', 'Preço por Litro (R$)': 18.0, 'Custo por Litro (R$)': 4.2, 'Lote de Produção': 'LOT-2026-042', 'Cliente (Se Emprestado no Cliente)': '', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'EM_ESTOQUE', 'Observações Gerais': 'Cheio na câmara fria' },
      { 'Código / Patrimônio do Barril': 'BAR-50L-003', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 50, 'Cerveja / Chopp Envasado': 'Hop Storm', 'Estilo da Cerveja': 'American IPA', 'Preço por Litro (R$)': 26.0, 'Custo por Litro (R$)': 6.5, 'Lote de Produção': 'LOT-2026-039', 'Cliente (Se Emprestado no Cliente)': 'Bar do Zé & Petiscos', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'NO_CLIENTE', 'Observações Gerais': 'Emprestado no cliente em comodato (Cheio)' },
      { 'Código / Patrimônio do Barril': 'BAR-30L-015', 'Capacidade Total (Litros)': 30, 'Qtd Real Envasada (Litros)': 0, 'Cerveja / Chopp Envasado': '', 'Estilo da Cerveja': '', 'Preço por Litro (R$)': '', 'Custo por Litro (R$)': '', 'Lote de Produção': '', 'Cliente (Se Emprestado no Cliente)': 'Boteco da Serra', 'Tipo de Barril': 'INOX_SLIM', 'Status Atual': 'NO_CLIENTE', 'Observações Gerais': 'Emprestado no cliente (Vazio aguardando recolha)' },
    ],
  },
  EQUIPMENT: {
    type: 'EQUIPMENT',
