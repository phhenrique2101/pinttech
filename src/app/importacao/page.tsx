...
const ENTITY_CONFIGS: Record<EntityType, EntityDefinition> = {
  ...
  KEGS: {
    ...
    fields: [
      ...
      { key: 'currentBeerName', label: 'Cerveja / Chopp Envasado', synonyms: ['chopp', 'cerveja', 'estilo', 'conteudo', 'produto', 'rotulo', 'rótulo'], example: 'German Pilsen' },
    ...
    sampleData: [
      { 'Código / Patrimônio do Barril': 'BAR-50L-001', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 0, 'Cerveja / Chopp Envasado': '', 'Lote de Produção': '', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'HIGIENIZADO', 'Observações Gerais': 'Válvula Tipo S' },
      { 'Código / Patrimônio do Barril': 'BAR-50L-002', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 50, 'Cerveja / Chopp Envasado': 'German Pilsen', 'Lote de Produção': 'LOT-2026-042', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'EM_ESTOQUE', 'Observações Gerais': 'Cheio no estoque' },
      { 'Código / Patrimônio do Barril': 'BAR-50L-003', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 35.5, 'Cerveja / Chopp Envasado': 'IPA Imperial', 'Lote de Produção': 'LOT-2026-039', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'EM_ESTOQUE', 'Observações Gerais': 'Retorno parcial de evento' },
      { 'Código / Patrimônio do Barril': 'BAR-30L-015', 'Capacidade Total (Litros)': 30, 'Qtd Real Envasada (Litros)': 0, 'Cerveja / Chopp Envasado': '', 'Lote de Produção': '', 'Tipo de Barril': 'INOX_SLIM', 'Status Atual': 'HIGIENIZADO', 'Observações Gerais': 'Novo' },
    ],
  },
  EQUIPMENT: {
    type: 'EQUIPMENT',
    ...
    sampleData: [
      { 'Código do Equipamento': 'CHOP-01', 'Nome / Modelo': 'Chopeira Elétrica 2 Vias 60L/h', 'Tipo de Equipamento': 'CHOPEIRA_ELETRICA', 'Voltagem': '220V', 'Número de Série': 'MEMO-4421', 'Status': 'DISPONIVEL', 'Observações': 'Torneiras Italianas' },
      { 'Código do Equipamento': 'CIL-CO2-05', 'Nome / Modelo': 'Cilindro CO2 6kg Válvula Top', 'Tipo de Equipamento': 'CILINDRO_CO2', 'Voltagem': '', 'Número de Série': 'CIL-6K-09', 'Status': 'DISPONIVEL', 'Observações': 'Cheio de gás' },
    ],
  },
  RECIPES: {
    type: 'RECIPES',
