...
const ENTITY_CONFIGS: Record<EntityType, EntityDefinition> = {
  ...
  KEGS: {
    ...
    sampleData: [
      { 'Código / Patrimônio do Barril': 'BAR-50L-001', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 0, 'Cerveja / Chopp Envasado': '', 'Estilo da Cerveja': '', 'Lote de Produção': '', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'HIGIENIZADO', 'Observações Gerais': 'Válvula Tipo S' },
      { 'Código / Patrimônio do Barril': 'BAR-50L-002', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 50, 'Cerveja / Chopp Envasado': 'German Pilsen', 'Estilo da Cerveja': 'Pilsner', 'Lote de Produção': 'LOT-2026-042', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'EM_ESTOQUE', 'Observações Gerais': 'Cheio no estoque' },
      { 'Código / Patrimônio do Barril': 'BAR-50L-003', 'Capacidade Total (Litros)': 50, 'Qtd Real Envasada (Litros)': 35.5, 'Cerveja / Chopp Envasado': 'Hop Storm', 'Estilo da Cerveja': 'American IPA', 'Lote de Produção': 'LOT-2026-039', 'Tipo de Barril': 'INOX_EURO', 'Status Atual': 'EM_ESTOQUE', 'Observações Gerais': 'Retorno parcial de evento' },
      { 'Código / Patrimônio do Barril': 'BAR-30L-015', 'Capacidade Total (Litros)': 30, 'Qtd Real Envasada (Litros)': 0, 'Cerveja / Chopp Envasado': '', 'Estilo da Cerveja': '', 'Lote de Produção': '', 'Tipo de Barril': 'INOX_SLIM', 'Status Atual': 'HIGIENIZADO', 'Observações Gerais': 'Novo' },
    ],
  },
  EQUIPMENT: {
    type: 'EQUIPMENT',
